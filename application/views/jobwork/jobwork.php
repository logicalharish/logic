...
//                                    $productData = $this->Commonmodel->getRecord('product_master', "*", array('id' => $job['product_id']));
		...
		$html .= '<tr>
                                    <td>' . $srno . '</td>
                                    <td style="width:20%">' . $invoiceDetailsData[$intIndex][$intIndex]['product_code'] . '</td>
                                    ...
                                    <td>' . $invoiceDetailsData[$intIndex]['taxable_value'] . '</td>';
		if ($invoiceDetailsData[$intIndex]['IGST_rate'] == 0)
		{
			
			$html .= '<td>' . number_format($invoiceDetailsData[$intIndex]['CGST_rate'], 2) . '</td>
                                    <td>' . number_format($invoiceDetailsData[$intIndex]['CGST_amount'], 2) . '</td>';
		} else
		{
			$html .= '<td>' . number_format($invoiceDetailsData[$intIndex]['IGST_rate'], 2) . '</td>
                                    <td>' . number_format($invoiceDetailsData[$intIndex]['IGST_amount'], 2) . '</td>';
		}
		$html .= ' <td><strong>' . number_format($invoiceDetailsData[$intIndex]['final_amount'], 2) . '</strong></td>
                                    </tr>';
	}
	$taxTotal		 = $Cgst  + $Igst;
