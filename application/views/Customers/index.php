<div id="headerbar">
    <h1 class="headerbar-title">Customers Info</h1>
    ...
    function getData() {
        ...
        ajax_table = $("#manageTbls").dataTable({
            ...
            "ColumnDefs": [
                ...
                {"width": "18%", "name": "type", "targets": 1},
                {"width": "18%", "name": "firstname", "targets": 1},
                {"width": "18%", "name": "lastname", "targets": 1},
                {"width": "8%", "name": "phone", "targets": 3, "orderable": false},
                {"width": "1%", "name": "phone2", "targets": 4, "orderable": false},
                {"width": "1%", "name": "email", "targets": 4, "orderable": false},
                {"width": "1%", "name": "website", "targets": 4, "orderable": false},
